...
pca_long[, population := paste(unlist(strsplit(individual, split = "_"))[2:3], collapse = "_"),
         by = individual]
...
dapc_results_opt <- dapc(snps_imputed,
                         n.pca = 10,
                         n.da = length(levels(pop(snps_imputed))) - 1)
...
dapc_long[, population := paste(unlist(strsplit(individual, split = "_"))[2:3], collapse = "_"),
         by = individual]
